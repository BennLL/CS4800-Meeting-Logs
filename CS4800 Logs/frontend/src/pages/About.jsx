...
function About() {
    return (
      <div className="About">
        <h1 className="home-title">About Nameless.</h1>
        <div className="about-content">
            <p>
                Nameless was founded in 2025 by a group of computer science students at Cal Poly Pomona for their
                software engineering course. CEO Joseph Moran and his software developers Ali Momennasab, Ethan Ngo, Joshua Yi, 
                and Zihao (Ben) Luo, wanted to create a streaming service that could offer a large amount of movies to movie lovers for free.
            </p>
            <p>
